    ...
    public void runTask() {
        ...
        if (month >= 1 && month <= 12) {
            ...
            if (day >= 1 && day <= 31) {
                ...
                System.out.println("ЛЕЕЕЕ НЕТУ ТАКОГО ДНЯ");
            }
            ...
            System.out.printf("самая жаркая погода была %d градусов в %d %s%n", maxTemp, maxDay, MONTHS.values()[month - 1]);
            ...
            System.out.println("ЛЕЕЕЕ нету такого месяца брат");
        }
    }
}
